          ...
          <div className='w-5/7 flex justify-end pr-5  space-x-4 items-center'>
            {isMobile ? null :
              <>
                ...
                <Link className='font-semibold hover:text-cyan-700' to='/users'>Utilisateurs</Link>
                <Link className='font-semibold hover:text-cyan-700' to='/categorie'>Catégories</Link>
                <Link className='font-semibold hover:text-cyan-700' to='/medics'>Produits</Link>
                <Link className='font-semibold hover:text-cyan-700' to='/confirm'>Réservations</Link>
                <Link className='font-semibold hover:text-cyan-700 ' to='/donations'>Dons</Link>
              </>
            }
